 ...
 * @author WHTNiroshika
 */
public class ProductionSearch extends javax.swing.JFrame {

    /** Creates new form ProductionSearch */
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            ResultSet rst = stm.executeQuery("select * from production where OrderNo='"+OrderNo+"'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProductionSearch.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
